...
/* Our doubly linked lists have two header elements: the "head"
   ...
   我们的双向链表有两个端点：“头节点”位于第一个元素的前方，而“尾节点”在最后一个元素的后面。
   头节点的“prev”是null，而“next”是其后面的一个节点，它们通过两条链相互连接。
...
/*
 * 返回链表的下一个元素；
 * 如果当前元素是最后一个链表元素，则返回尾结点；
 * 如果当前节点是尾节点，那么返回值是尾定义的
 */
