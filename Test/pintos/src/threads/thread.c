...
void thread_set_priority(int new_priority)
{
    ...
    count_set++;
    printf("(thread_set_priority %d) new_priority = %d\n", count_set, new_priority);
    count_set++;
    printf("(thread_set_priority %d) thread_current() -> name = %s\n", count_set, thread_current() -> name);
    count_set++;
    printf("(thread_set_priority %d) thread_set_priority before = %d\n", count_set, thread_current() -> priority);

    /*
     * 如果当前线程的优先级比new_priority低的话，
     * 则直接提升该线程的优先级
     *
     * 如果当前线程的优先级比new_priority高的话，
